	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h3>Provider Name <span><?php echo $result[0]->full_name;?></span></h3>
			</div>
		</div>
								...
								<div class="row">
									...
									<div class="col-md-3">
										<a class="btn center-block">
											<i class="fa fa-dollar"></i> <?php echo $dt['min_price'];?> - $<?php echo $dt['max_price'];?>
										</a>
									</div>
								</div>
							</div>
								...
								<div class="media">
									...
									<div class="media-body">
										<h4 class="media-heading h4 text-uppercase"><?php echo $dt['service_name'];?>
                                                                                        <span class="">$<?php if($dt['mp']!=''){echo $dt['mp'];}else{echo 0; }?></span>
