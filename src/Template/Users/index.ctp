 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images/s.jpg" alt="" style="width:100%;">
      </div>
...
<!--								<a href="<?php echo $this->Url->build(["controller" => "Users","action" => "servicedetails",$dt['details'][0]['service_id']]);?>" class="btn-sm btn"><i class="fa fa-arrow-down"></i> More Details</a>-->
						...
						<a href="<?php echo $this->Url->build(["controller" => "Users","action" => "servicedetails",'P_'.$dt['details'][0]['company']['id']]);?>" class="text-center text-uppercase btn btn-block">View Details</a>
					</div>
				</div>
