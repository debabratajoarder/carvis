                ...
                <div class="box">
				  ...
				  <?php echo $this->Form->create($medicine,['class' => 'form-horizontal', 'id' => 'medicine-validate', 'type' => 'post', 'enctype' => 'multipart/form-data']);?>
                                    ...
                                    <div class="fileupload fileupload-new" data-provides="fileupload">
                                        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
                                            ...
                                            <?php if ($medicine->image != "" && file_exists($filePath)) { ?>
                                                <img src="<?php echo $this->Url->build('/medicine_img/'.$medicine->image); ?>" width="150px" height="150px" />
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Edit Medicine" class="btn btn-primary" />
                                </div>
                                </form>
                            </div>
                        </div>
