                                ...
                                <li style="margin-right:15px">
                                    <div class="btn-group"> 
                                        <a href="<?php echo $this->Url->build(["controller" => "Users", "action" => "addserviceprovider"]); ?>">
                                            <button class="btn btn-xs btn-success close-box"> <i class="icon-plus"></i> Add Service provider</button></a>
...
<!--                              <div class="form-group">
                  ...
                  <div class="company-images col-lg-8">
                    ...
                    <div class="manage-photo" id="product_images1" style="overflow:scroll; height:450px;width:500px;">
                                ...
                                <label class="control-label col-lg-4"></label>
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Edit Service provider" class="btn btn-primary" />
                                </div>
