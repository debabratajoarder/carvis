                            ...
                            <ul class="nav">
                                <li style="margin-right:15px">
                                    <div class="btn-group" style=" margin-top: 8px">
                                        <a href="<?php echo $this->Url->build(["action" => "addservice/", $id]); ?>"> <button class="btn btn-info btn-xs"><i class="icon-cogs icon-white"></i> Add Service </button>  </a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                           ...
                                           <?php $i = 1; foreach ($service as $dt): ?>
                                                   <tr>
                                                       ...
                                                       <td><?php echo h($dt->address) ?></td>
                                                        ...
                                                        <td><?php echo h($dt->city_name) ?></td>
                                                        <td><?php echo h($dt->country) ?></td>
