                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Service Type Name</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Service Description</label>
                                    <div class="col-lg-8">
...
<!--                            <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-lg-4">Service Icon</label>
                                  <div class="col-lg-8">
                                ...
                                <div class="col-lg-8" style="text-align:left;"> 
                                    <input type="submit" name="submit" value="Edit Service Type" class="btn btn-primary" />
                                </div>
