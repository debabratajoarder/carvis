...
<div id="content">
    <div class="inner">
        <div class="row">
            <div class="col-lg-12">
                <h1 > News and Announcements List </h1>
            </div>
        </div>
        <hr />
        <div class="row">
            <div class="col-lg-12">
                <div class="box">
                    <header>
                        ...
                        <h5> News and Announcements List</h5>
                        <div class="toolbar">
                            <ul class="nav">
                                <li style="margin-right:15px">
                                    <div class="btn-group" style=" margin-top: 8px">
                                        <a href="<?php echo $this->Url->build(["action" => "add"]); ?>"> <button class="btn btn-info btn-xs"><i class="icon-cogs icon-white"></i> Add News and Announcements</button>  </a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                              <thead>
                                                <tr>
                                                  ...
                                                  <th style="width: 59%"><?php echo $this->Paginator->sort('Title') ?></th>
                                                  <th style="width: 10%"><?php echo $this->Paginator->sort('Status') ?></th>
                                                  <th style="width: 25%"><?php echo  __('Actions') ?></th>
                                                </tr>
                                              </thead>
                                              <tbody>
                                                <?php $i = 1; ?>
                                                <?php foreach ($news as $dt): ?>  
                                                <tr>
                                                  <td> <?php echo $i ?> </td>
                                                  <td><?php echo h($dt->title) ?></td>
                                                  <td><?php echo h($dt->status = 1 ? 'Active' : 'Inactiive') ?></td>
                                                  <td>
